...
class CreateUsers extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->tinyInteger('status')->default(1);// 1 for inactive 2 for active
            ...
            $table->integer('current_portfolio_id')->nullable()->unsigned();
            $table->integer('current_campaign_id')->nullable()->unsigned();
