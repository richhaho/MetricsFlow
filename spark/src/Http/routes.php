...
$router->group(['middleware' => 'web'], function ($router) {
    ...
    $router->get('/users/activate/{token}', 'UserController@getActivate');
    $router->post('/users/activate/{token}', 'UserController@postActivate');
    
    //campaign's
    $router->get('/campaigns/{team_id}', 'CampaignController@index');
    $router->get('/campaigns/create/{team_id}', 'CampaignController@create');
    $router->post('/campaigns/store', 'CampaignController@store');

    // data fetching
    $router->get('/data', 'DataFetchController@csv');
});
