        ...
        <table width="80%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="left" width="95%" style="font: 13px/18px Arial, Helvetica, sans-serif;">
                    ...
                    You are inviter to join in our campaign system. We listed your sign in details below, make sure you keep them safe.<br />
                    ...
                    <nobr>
                        <a  target="_blank" href="<?php echo url('users/activate/'.$user['token'])?>">
                            <?php
